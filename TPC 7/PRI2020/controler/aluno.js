...
// Listar todos os alunos ordenados pelo  numero
...
// Consultar um determinado aluno pelo id
...
// Inserir um novo aluno onde a informacao fica no body da mensagem
module.exports.inserir = a => {
    var novo = new Aluno(a.body)
    return novo.save()
}

// Eliminar um determinado aluno pelo id
...
// Atualizar um determinado aluno pelo id com a informacao que vai no aluno
