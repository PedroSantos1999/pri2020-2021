...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
        ...
        <xsl:result-document href="arq-Website/tableofcontents.html">
            <html>
                ...
                <body>
                    ...
                    <hr/>
                    <footer>
                        <p>Autor: Pedro Afonso Rodrigues Santos</p>
                        <p>MEI - 4ºAno - 1ºSemestre - PRI 20/21</p>
                        <p>
                            <a href="mailto:pg42847@alunos.uminho.pt">pg42847@alunos.uminho.pt</a>
                        </p>
                        <a href="https://github.com/PedroSantos99/pri2020-2021" target="_blank">
    ...
    <xsl:template match="ARQELEM">
        <xsl:result-document href="arq-Website/arq-{generate-id()}.html">
            <html>
                <style>
                    h2{font-size: 24; text-align: center;}
                    body{background-color: LightGray;}
                    footer{text-align: center; padding: 3px; color: blue;}
                </style>
                <head>
